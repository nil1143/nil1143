              ...
              <CardContent>
                <div className="space-y-4">
                  {project.highlights.map((highlight, index) => (
                    <div
                      key={index}
                      className={`border-l-4 border-${highlight.color}-500 pl-4 py-1`}
                    >
                      <div className="flex items-start gap-2 mb-1">
                        <AlertCircle className={`w-4 h-4 text-${highlight.color}-500 mt-0.5 flex-shrink-0`} />
                ...
                <div className="flex gap-2 flex-wrap">
                  {project.technologies.map((tech, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="flex items-center gap-2 px-3 py-2 rounded-lg bg-gradient-to-br from-accent/30 to-accent/10 dark:from-accent/20 dark:to-accent/5 border border-border/50 hover:from-accent/50 hover:to-accent/20 transition-all duration-200"
                        title={tech.name}
                      >
                        <TechIcon
                          className="w-4 h-4"
